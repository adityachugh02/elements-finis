...
//
    ...
    femElasticityAddBoundaryCondition(theProblem,"Hole",DIRICHLET_X,0.0);
    femElasticityAddBoundaryCondition(theProblem,"Hole",DIRICHLET_Y,0.0);
